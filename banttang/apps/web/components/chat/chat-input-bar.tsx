...
export function ChatInputBar({
  ...
  if (readOnly) {
    return (
      <div className="sticky bottom-14 z-20 border-t border-black/[0.06] bg-gray-50 px-4 py-3 pb-[max(env(safe-area-inset-bottom),0.75rem)]">
  ...
  return (
    <form
      ...
      className="sticky bottom-14 z-20 border-t border-black/[0.06] bg-white px-3 pb-[max(env(safe-area-inset-bottom),0.5rem)] pt-2"
    >
      {(error || showCounter) && (
